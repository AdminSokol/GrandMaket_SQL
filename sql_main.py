                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO1 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO1 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number001, order in enumerate(users):
                            form.tableWidget.insertRow(row_number001)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO1 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number001, order in enumerate(users):
                            form.tableWidget.insertRow(row_number001)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO1 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number001, order in enumerate(users):
                            form.tableWidget.insertRow(row_number001)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number001) + 1):
                                ...
                                repair = form.tableWidget.item(i, 1).text()
                                redukt = form.tableWidget.item(i, 2).text()
                                master = form.tableWidget.item(i, 3).text()
                                userid = form.tableWidget.item(i, 4).text()
                                hours = form.tableWidget.item(i, 5).text()
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO1 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO2 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO2 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number002, order in enumerate(users):
                            form.tableWidget.insertRow(row_number002)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO2 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number002, order in enumerate(users):
                            form.tableWidget.insertRow(row_number002)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO2 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number002, order in enumerate(users):
                            form.tableWidget.insertRow(row_number002)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number002) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO2 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO3 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO3 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number003, order in enumerate(users):
                            form.tableWidget.insertRow(row_number003)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO3 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number003, order in enumerate(users):
                            form.tableWidget.insertRow(row_number003)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO3 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number003, order in enumerate(users):
                            form.tableWidget.insertRow(row_number003)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number003) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO3 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO4 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO4 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number004, order in enumerate(users):
                            form.tableWidget.insertRow(row_number004)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO4 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number004, order in enumerate(users):
                            form.tableWidget.insertRow(row_number004)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO4 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number004, order in enumerate(users):
                            form.tableWidget.insertRow(row_number004)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number004) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO4 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO5 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO5 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number005, order in enumerate(users):
                            form.tableWidget.insertRow(row_number005)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO5 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number005, order in enumerate(users):
                            form.tableWidget.insertRow(row_number005)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO5 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number005, order in enumerate(users):
                            form.tableWidget.insertRow(row_number005)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number005) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO5 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO6 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO6 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number006, order in enumerate(users):
                            form.tableWidget.insertRow(row_number006)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO6 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number006, order in enumerate(users):
                            form.tableWidget.insertRow(row_number006)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO6 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number006, order in enumerate(users):
                            form.tableWidget.insertRow(row_number006)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number006) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO6 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO7 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO7 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number007, order in enumerate(users):
                            form.tableWidget.insertRow(row_number007)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def vneplan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO7 WHERE loko='{iter}' AND repair='Внеплан' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number007, order in enumerate(users):
                            form.tableWidget.insertRow(row_number007)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO7 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number007, order in enumerate(users):
                            form.tableWidget.insertRow(row_number007)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number007) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO7 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
            ...
            if e.button() == Qt.RightButton:
                ...
                if it.column() == 2:
                    ...
                    def all():
                        ...
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO8 WHERE loko='{iter}' ORDER BY DATE('%d.%m.%Y')""")
                    ...
                    def plan():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO8 WHERE loko='{iter}' AND repair='План' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number008, order in enumerate(users):
                            form.tableWidget.insertRow(row_number008)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def repair():
                        form.tableWidget.setRowCount(0)
                        users = cursor.execute(
                            f"""SELECT ID,repair,redukt,master,userid,hours,datas FROM TO8 WHERE loko='{iter}' AND repair='Ремонт' ORDER BY DATE('%d.%m.%Y')""")
                        for row_number008, order in enumerate(users):
                            form.tableWidget.insertRow(row_number008)
                            for column_number, data in enumerate(order):
                                cell = QtWidgets.QTableWidgetItem(str(data))
                    ...
                    def save():
                        try:
                            for i in range(int(row_number008) + 1):
                                ...
                                datas = form.tableWidget.item(i, 6).text()
                                cursor.execute(
                                    f"""UPDATE TO8 SET loko='{iter}',repair='{repair}',redukt='{redukt}',master='{master}',userid='{userid}',hours='{hours}',datas='{datas}' WHERE ID='{ID}'""")
                            sqlite_connection.commit()
                        except:
                            pass
                    form.pushButton_plus.clicked.connect(plus)
                        ...
                        if it.column() == 2:
                            ...
                            def all():
                                ...
                                users00 = cursor.execute(
                                    f"""SELECT one,two,three,foo FROM poll""")
                            ...
                            def plan():
                                form.tableWidget.setRowCount(0)
                                users00 = cursor.execute(
                                    f"""SELECT one,two,three,foo FROM poll WHERE three='План'""")
                                for row_number8, order in enumerate(users00):
                                    form.tableWidget.insertRow(row_number8)
                                    for column_number, data in enumerate(order):
                                        cell = QtWidgets.QTableWidgetItem(str(data))
                            ...
                            def vneplan():
                                form.tableWidget.setRowCount(0)
                                users00 = cursor.execute(
                                    f"""SELECT one,two,three,foo FROM poll WHERE three='Внеплан'""")
                                for row_number8, order in enumerate(users00):
                                    form.tableWidget.insertRow(row_number8)
                                    for column_number, data in enumerate(order):
                                        cell = QtWidgets.QTableWidgetItem(str(data))
                            ...
                            def repair():
                                form.tableWidget.setRowCount(0)
                                users00 = cursor.execute(
                                    f"""SELECT one,two,three,foo FROM poll WHERE three='Ремонт'""")
                                for row_number8, order in enumerate(users00):
                                    form.tableWidget.insertRow(row_number8)
                                    for column_number, data in enumerate(order):
                                        cell = QtWidgets.QTableWidgetItem(str(data))
